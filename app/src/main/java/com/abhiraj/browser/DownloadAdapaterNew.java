...
public class DownloadAdapaterNew extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    Context context;
    List<DownloadModelNew> downloadModels = new ArrayList<>();
    ItemClickListener clickListener;

    public DownloadAdapaterNew(Context context, List<DownloadModelNew> downloadModels, ItemClickListener itemClickListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.download_row_n, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        final DownloadModelNew downloadModel = downloadModels.get(position);
    ...
    private boolean pauseDownload(DownloadModelNew downloadModel) {
        int updatedRow = 0;
    ...
    private boolean resumeDownload(DownloadModelNew downloadModel) {
        int updatedRow = 0;
        ContentValues contentValues = new ContentValues();
    ...
    public void changeITem(long downloadid) {
        int i = 0;
        for (DownloadModelNew downloadModel : downloadModels) {
    ...
    public void setChangeItemPath(final String path, long id) {
        Realm realm = Realm.getDefaultInstance();
